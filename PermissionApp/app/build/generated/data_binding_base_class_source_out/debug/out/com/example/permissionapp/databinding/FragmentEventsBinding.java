...
public final class FragmentEventsBinding implements ViewBinding {
  ...
  private FragmentEventsBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textGallery) {
  ...
  public static FragmentEventsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentEventsBinding((ConstraintLayout) rootView, textGallery);
    }
