...
public final class FragmentScanBinding implements ViewBinding {
  ...
  private FragmentScanBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textSlideshow) {
  ...
  public static FragmentScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentScanBinding((ConstraintLayout) rootView, textSlideshow);
    }
